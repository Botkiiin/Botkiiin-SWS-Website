...
const MDXComponents: MDXComponentsProps = {
  ...
  h2: (props) => (
    <Heading
      level={2}
      className="text-3xl font-semibold mt-8 mb-6 border-b-2 border-gray-200 dark:border-gray-700 pb-2"
      {...props}
    />
  ),
  ...
  hr: (props) => <hr className="border-t border-gray-200 dark:border-gray-700 my-8" {...props} />,
  p: (props) => <p className="mt-6 mb-6 leading-relaxed" {...props} />,
  a: (props) => (
    <a
  ...
  code: (props) => (
    <code className="bg-gray-100 dark:bg-gray-700 rounded px-2 py-1 font-mono text-sm" {...props} />
  ),
  pre: (props) => (
    <pre className="rounded-lg p-4 overflow-x-auto my-4 bg-gray-100 dark:bg-gray-800" {...props} />
  ),
  blockquote: (props) => (
    <blockquote
      className="pl-6 border-l-4 border-gray-300 dark:border-gray-600 my-6 text-gray-600 dark:text-gray-400 italic"
      {...props}
    />
  ),
  img: (props) => {
    ...
    return (
      <Image
        ...
        width={width}
        height={height}
        className="rounded-lg border-2 border-gray-200 dark:border-gray-700 my-6"
        loading="lazy"
        {...rest}
      />
    );
  ...
  tr: (props) => <tr className="border-t border-gray-200 dark:border-gray-700" {...props} />,
  th: (props) => (
    <th
  ...
  td: (props) => (
    <td
      className="px-6 py-4 text-left border-t border-gray-100 dark:border-gray-600 [&[align=center]]:text-center [&[align=right]]:text-right"
      {...props}
    />
  ),
  Aside,
